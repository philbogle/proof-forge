...
- For "english": Provide a step-by-step intuitive explanation. Use absolutely no math notation except very simple things like $x$ and $A(x)$. Explain everything in plain English, to someone with high-school level math background. **When introducing a mathematical term, please provide a brief, one-sentence definition formatted like this: 💡 (your definition here).**
- For "semiformal": Provide a step-by-step proof but allow for intuition and non-rigorous shortcuts. Use math notation for mathematical concepts where it aids clarity. The formulas should not be overly complex. **When introducing a potentially unfamiliar mathematical term, please provide a brief, one-sentence definition formatted like this: 💡 (your definition here).**
