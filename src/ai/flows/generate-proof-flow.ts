...
- **For long definitions (more than a sentence or two):** Use the HTML <details> and <summary> tags to create a collapsible block. The <summary> should contain the term being defined. For example:
<details>
