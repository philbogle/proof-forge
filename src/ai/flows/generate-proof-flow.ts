...
- For "english": Provide a step-by-step intuitive explanation. Use absolutely no math notation except very simple things like $x$ and $A(x)$. Explain everything in plain English, to someone with high-school level math background. **When introducing a mathematical term, define it naturally within the sentence by italicizing the term, like this: "... which is an example of a *set*, or a collection of distinct objects."**
- For "semiformal": Provide a step-by-step proof but allow for intuition and non-rigorous shortcuts. Use math notation for mathematical concepts where it aids clarity. The formulas should not be overly complex. **When introducing a potentially unfamiliar mathematical term, define it naturally within the sentence by italicizing the term, like this: "... we use the concept of a *bijection*, which is a one-to-one correspondence between two sets."**
